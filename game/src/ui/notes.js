...
export const NOTES = [
  ...
  },
  {
    ...
    term: "往后续字",
    blurb: "从开头接新格子",
    note: "读存档，从换行或你给的开头，一格一格把新号码接到纸带后面。旋钮不再拧。默认温度 0.8，就是少乱跳一点。字只有 65 个，所以说留前 200 名，其实一个也不丢。也不打正确率。这里没有编出来的台词。大人把这一步叫做采样。存档文件是 out-shakespeare-char/ckpt.pt。电脑上要打的字：python sample.py --out_dir=out-shakespeare-char。",
  },
];
