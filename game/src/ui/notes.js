...
export const NOTES = [
  ...
  },
  {
    ...
    term: "注意力",
    blurb: "每一格回头看左边",
    note: "每一格只看自己和左边的格子，按重量把内容加回来，再加回原来的这一格。右边不给看。",
  },
  {
    id: "qkv",
    term: "提问 / 标签 / 内容",
    blurb: "一格切开的三份",
    note: "同一格先变成三份。提问去比标签。比完才搬内容。shakespeare_char 里每一份宽 384。",
  },
  {
    id: "mask",
    term: "因果遮罩",
    blurb: "右边填上负无穷",
    note: "下三角留下。右上角的分数改成负无穷，所以那些格子分不到重量。字还在纸带上，只是这一格不准看。",
  },
  {
    id: "softmax",
    term: "一份重量",
    blurb: "能看的格子加起来是 1",
    note: "先把分数除以根号下的头宽（64 的根号是 8），再变成加起来为 1 的重量。右边是 0。这不是罚分。",
  },
  {
    id: "train",
    term: "开训",
    blurb: "按罚分改一笔",
    note: "从练习卷剪一批窗口，往前算，记下猜错罚分，往回传，再用 AdamW 改模型里的数。验收卷只抽查，不拿来改。这里不写假的罚分。",
  },
  {
    id: "sample",
    term: "采样",
    blurb: "从开头往后续字",
    note: "读检查点，从换行或你给的开头，一格一格把新号码接到纸带后面。默认温度 0.8。词表只有 65，所以默认的前 200 名等于全留。不改数，也不打正确率。本仓库没有生成出来的台词。",
  },
];
