...
import { LEVEL1_BEATS, LEVEL2_BEATS, LEVEL3_BEATS, LEVEL4_BEATS, PHASE_COUNT } from "./data/beats.js";
...
const config = {
  ...
  scene: [BootScene, TitleScene, Level1Scene, Level2Scene, Level3Scene, Level4Scene, EndScene],
};
