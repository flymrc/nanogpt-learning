...
- **目录** lists 5 chapters (准备纸带 / 猜下一个 / 只看左边 / 按罚分改 / 往后续字). Short buttons stay 准备 / 罚分 / 注意 / 开训 / 采样. Every chapter starts at beat 0 and can be revisited. **返回** steps to the previous phase, then the previous beat, then the previous chapter.
