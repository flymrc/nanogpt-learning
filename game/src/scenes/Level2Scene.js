...
const RENDERERS = {
  clip: drawClipExample,
  seen: drawSeenExample,
  shift: drawShiftExample,
  blanks: drawBlankExample,
  choices: drawChoiceExample,
  desk: drawDeskExample,
  surprise: drawScoreExample,
  mean: drawMeanExample,
};
