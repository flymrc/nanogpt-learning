...
| 3 | Causal Self-Attention（`model.py` 的 QKV / 遮罩 / softmax / 加权汇总） | **笔记已完成**（2026-09-22），未开训 | [notes/03-causal-self-attention.md](notes/03-causal-self-attention.md) |
...
```
notes/          # 按步骤展开的学习笔记
game/           # Phaser 3 闯关：第 1–3 章点击动画（见 game/README.md）
...
游戏用 19 拍把笔记讲成纸带类比：第 1–2 章 13 拍，第 3 章 6 拍讲因果注意力。每一课可以点「伪代码」。宽屏电脑右侧会出 Live2D 助教，手机不加载。详情见 [`game/README.md`](game/README.md)。
